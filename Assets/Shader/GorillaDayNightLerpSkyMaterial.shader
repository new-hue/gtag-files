Shader "Gorilla/DayNightLerpSkyMaterial" {
	Properties {
		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0 = texture(_Tex2, vs_TEXCOORD0.xy);
					    u_xlat1 = texture(_Tex1, vs_TEXCOORD0.xy);
					    u_xlat0 = u_xlat0 + (-u_xlat1);
					    SV_Target0 = vec4(_LerpValue) * u_xlat0 + u_xlat1;
					    return;
					}"
				}
				SubProgram "d3d11 " {
