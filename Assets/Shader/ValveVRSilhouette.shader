			...
			Program "gp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat3.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[(u_xlati28 + 1) / 4][(u_xlati28 + 1) % 4].yyy;
					    u_xlat3.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[(u_xlati28 + 1) / 4][(u_xlati28 + 1) % 4].xxx + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[(u_xlati28 + 1) / 4][(u_xlati28 + 1) % 4].zzz + u_xlat3.xyz;
					    u_xlat3.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[(u_xlati28 + 1) / 4][(u_xlati28 + 1) % 4].www + u_xlat3.xyz;
					    u_xlat29 = dot(u_xlat3.xyz, u_xlat1.xyz);
					    u_xlat4.xy = vec2(u_xlat29) * unity_StereoMatrixP[(u_xlati28 + 1) / 4][(u_xlati28 + 1) % 4].xy;
					    u_xlat5.xyz = unity_WorldToObject[1].xyz * unity_StereoMatrixInvV[u_xlati28 / 4][u_xlati28 % 4].yyy;
					    u_xlat5.xyz = unity_WorldToObject[0].xyz * unity_StereoMatrixInvV[u_xlati28 / 4][u_xlati28 % 4].xxx + u_xlat5.xyz;
					    u_xlat5.xyz = unity_WorldToObject[2].xyz * unity_StereoMatrixInvV[u_xlati28 / 4][u_xlati28 % 4].zzz + u_xlat5.xyz;
					    u_xlat5.xyz = unity_WorldToObject[3].xyz * unity_StereoMatrixInvV[u_xlati28 / 4][u_xlati28 % 4].www + u_xlat5.xyz;
					    u_xlat29 = dot(u_xlat5.xyz, u_xlat1.xyz);
					    u_xlat4.xy = unity_StereoMatrixP[u_xlati28 / 4][u_xlati28 % 4].xy * vec2(u_xlat29) + u_xlat4.xy;
					    ...
					    u_xlat6 = unity_ObjectToWorld[2] * vs_TEXCOORD0[0].zzzz + u_xlat6;
					    u_xlat6 = u_xlat6 + unity_ObjectToWorld[3];
					    u_xlat7 = u_xlat6.yyyy * unity_StereoMatrixVP[(u_xlati28 + 1) / 4][(u_xlati28 + 1) % 4];
					    u_xlat7 = unity_StereoMatrixVP[u_xlati28 / 4][u_xlati28 % 4] * u_xlat6.xxxx + u_xlat7;
					    u_xlat7 = unity_StereoMatrixVP[(u_xlati28 + 2) / 4][(u_xlati28 + 2) % 4] * u_xlat6.zzzz + u_xlat7;
					    u_xlat6 = unity_StereoMatrixVP[(u_xlati28 + 3) / 4][(u_xlati28 + 3) % 4] * u_xlat6.wwww + u_xlat7;
					    u_xlat4.xy = u_xlat4.xy * u_xlat6.ww;
					    u_xlat4.xy = u_xlat4.xy * vec2(g_flOutlineWidth) + u_xlat6.xy;
					    gl_Position.xy = u_xlat4.xy;
					    gl_Position.zw = u_xlat6.zw;
					    ...
					    u_xlat29 = inversesqrt(u_xlat29);
					    u_xlat2.xyz = u_xlat7.xyz * vec3(u_xlat29) + (-u_xlat2.xyz);
					    ...
					    gs_TEXCOORD1.xyz = u_xlat2.xyz;
					    u_xlat27 = dot(u_xlat3.xyz, u_xlat2.xyz);
					    u_xlat22.xy = vec2(u_xlat27) * unity_StereoMatrixP[(u_xlati28 + 1) / 4][(u_xlati28 + 1) % 4].xy;
					    u_xlat27 = dot(u_xlat5.xyz, u_xlat2.xyz);
					    u_xlat22.xy = unity_StereoMatrixP[u_xlati28 / 4][u_xlati28 % 4].xy * vec2(u_xlat27) + u_xlat22.xy;
					    u_xlat27 = dot(u_xlat22.xy, u_xlat22.xy);
					    u_xlat27 = inversesqrt(u_xlat27);
					    u_xlat22.xy = vec2(u_xlat27) * u_xlat22.xy;
					    u_xlat7 = unity_ObjectToWorld[1] * vs_TEXCOORD0[1].yyyy;
					    ...
					    u_xlat7 = unity_ObjectToWorld[2] * vs_TEXCOORD0[1].zzzz + u_xlat7;
					    u_xlat7 = u_xlat7 + unity_ObjectToWorld[3];
					    u_xlat8 = u_xlat7.yyyy * unity_StereoMatrixVP[(u_xlati28 + 1) / 4][(u_xlati28 + 1) % 4];
					    u_xlat8 = unity_StereoMatrixVP[u_xlati28 / 4][u_xlati28 % 4] * u_xlat7.xxxx + u_xlat8;
					    u_xlat8 = unity_StereoMatrixVP[(u_xlati28 + 2) / 4][(u_xlati28 + 2) % 4] * u_xlat7.zzzz + u_xlat8;
					    u_xlat7 = unity_StereoMatrixVP[(u_xlati28 + 3) / 4][(u_xlati28 + 3) % 4] * u_xlat7.wwww + u_xlat8;
					    u_xlat22.xy = u_xlat22.xy * u_xlat7.ww;
					    u_xlat22.xy = u_xlat22.xy * vec2(g_flOutlineWidth) + u_xlat7.xy;
					    gl_Position.xy = u_xlat22.xy;
					    gl_Position.zw = u_xlat7.zw;
					    ...
					    gs_TEXCOORD1.xyz = u_xlat0.xyz;
					    u_xlat27 = dot(u_xlat3.xyz, u_xlat0.xyz);
					    u_xlat3.xy = vec2(u_xlat27) * unity_StereoMatrixP[(u_xlati28 + 1) / 4][(u_xlati28 + 1) % 4].xy;
					    u_xlat27 = dot(u_xlat5.xyz, u_xlat0.xyz);
					    u_xlat3.xy = unity_StereoMatrixP[u_xlati28 / 4][u_xlati28 % 4].xy * vec2(u_xlat27) + u_xlat3.xy;
					    u_xlat27 = dot(u_xlat3.xy, u_xlat3.xy);
					    u_xlat27 = inversesqrt(u_xlat27);
					    u_xlat3.xy = vec2(u_xlat27) * u_xlat3.xy;
					    u_xlat5 = unity_ObjectToWorld[1] * vs_TEXCOORD0[2].yyyy;
					    ...
					    u_xlat5 = unity_ObjectToWorld[2] * vs_TEXCOORD0[2].zzzz + u_xlat5;
					    u_xlat5 = u_xlat5 + unity_ObjectToWorld[3];
					    u_xlat7 = u_xlat5.yyyy * unity_StereoMatrixVP[(u_xlati28 + 1) / 4][(u_xlati28 + 1) % 4];
					    u_xlat7 = unity_StereoMatrixVP[u_xlati28 / 4][u_xlati28 % 4] * u_xlat5.xxxx + u_xlat7;
					    u_xlat7 = unity_StereoMatrixVP[(u_xlati28 + 2) / 4][(u_xlati28 + 2) % 4] * u_xlat5.zzzz + u_xlat7;
					    u_xlat5 = unity_StereoMatrixVP[(u_xlati28 + 3) / 4][(u_xlati28 + 3) % 4] * u_xlat5.wwww + u_xlat7;
					    u_xlat3.xy = u_xlat3.xy * u_xlat5.ww;
					    u_xlat3.xy = u_xlat3.xy * vec2(g_flOutlineWidth) + u_xlat5.xy;
					    gl_Position.xy = u_xlat3.xy;
					    gl_Position.zw = u_xlat5.zw;
